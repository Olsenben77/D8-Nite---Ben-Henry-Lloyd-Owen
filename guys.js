$(document).ready(function() {
  ...
  function settings(id) {
    var settings = {
      ...
      crossDomain: true,
      url:
        "https://tripadvisor1.p.rapidapi.com/attractions/list?lang=en_US&currency=USD&sort=recommended&lunit=km&limit=30&bookable_first=false&subcategory=36&location_id=" +
        id,
      method: "GET",
      headers: {
        "x-rapidapi-host": "tripadvisor1.p.rapidapi.com",
